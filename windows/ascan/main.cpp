...
int Execute(char* argsBuffer, uint32_t bufferSize, goCallback callback) {
    ...
    if (pingOnlyFlag) {
        ...
        if (portRange == NULL) {
            portRange = _strdup("20,21,22,23,25,53,65,66,69,80,88,110,111,135,139,143,194,389,443,445,464,465,587,593,636,873,993,995,1194,1414,1433,1494,1521,1540,1666,1801,1812,1813,1883,2049,2179,2181,2222,2383,2598,3000,3128,3268,3269,3306,3333,3389,4222,4369,4444,4848,5000,5044,5060,5061,5432,5445,5552,5555,5601,5631,5666,5671,5672,5693,5900,5931,5938,5984,5985,5986,6160,6200,6379,6443,6600,6650,6771,7001,7474,7676,7687,7777,7990,8000,8006,8080,8081,8082,8086,8088,8090,8091,8161,8200,8222,8443,8444,8500,8529,8530,8531,8600,8883,8888,8912,9000,9042,9080,9090,9092,9160,9200,9229,9300,9389,9443,9515,9999,10000,10001,10011,10050,10051,11211,15672,17990,25672,27015,27017,30033,47001,61613,61614,61616");
            isNoPorts = 1;
        }
        g_isPingOnly = 0;
    }
